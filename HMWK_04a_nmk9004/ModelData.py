...
#-----------------------------------------------------------------------------------------------------------------------
  def specifyEulerAngles(self, roll_angle, pitch_angle, yaw_angle, ax, ay, sx, sy, ):
      ...
      print("r00 {:.3f}".format(r00), "r01 {:.3f}".format(r01), "r02 {:.3f}".format(r02)  )
      print("r10 {:.3f}".format(r10), "r11 {:.3f}".format(r11), "r12 {:.3f}".format(r12))
      print("r20 {:.3f}".format(r20), "r21 {:.3f}".format(r21), "r22 {:.3f}".format(r22))
      print("ex  {:.3f}".format(ex),   "ey {:.3f}".format(ey),   "ez {:.3f}".format(ez))
#-----------------------------------------------------------------------------------------------------------------------
